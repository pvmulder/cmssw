...
process.combinedSVTrainer = cms.EDAnalyzer("JetTagMVATreeTrainer",
	...
	fileNames = cms.vstring(
		...
		" /user/pvmulder/NewEraOfDataAnalysis/BTagServiceWork/DEVELOPMENT/CMSSW_5_3_4_patch1/src/CrabJobs_modified1_tightTrackSel/RootFiles/QCD_training/skimmed_20k_eachptetabin_CombinedSVPseudoVertex_DUSG.root"
	),
